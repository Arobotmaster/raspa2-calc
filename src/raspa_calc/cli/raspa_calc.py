...
from raspa_calc.core import env_check
from raspa_calc.core import menu
from raspa_calc.modes import parameter_screening as parameter_screening_cmd
from raspa_calc.modes import ciffilter as ciffilter_cmd
from raspa_calc.modes import data_extractor as data_extractor_cmd
from raspa_calc.modes import isotherm_plotter as isotherm_plotter_cmd
from raspa_calc.modes import high_throughput as high_throughput_cmd
from raspa_calc.modes import warning_processor as warning_processor_cmd
...
def main():
    ...
    if not env_check.check_disk_space():
        sys.exit(1)

    if not skip_check and not env_check.check_environment():
        print("\n💡 建议解决方案:")
