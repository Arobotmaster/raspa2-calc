...
用法:
    python -m raspa_calc.domain.algorithms.raspa3_generator --config config.yaml
    或
    python -m raspa_calc.domain.algorithms.raspa3_generator --csv data.csv --framework-column coreid --output-dir output
"""
