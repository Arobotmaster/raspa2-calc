...
def main():
    ...
    if raspa_version == "raspa3":
        ...
        try:
            ...
            from raspa_calc.tools.data_extractor_raspa3 import (
                find_and_process_files_high_throughput as raspa3_process,
            )
            from raspa_calc.tools.data_extractor_raspa3 import save_results_to_file as raspa3_save
    ...
    if raspa_version == "raspa3":
        ...
        if use_high_throughput:
            from raspa_calc.tools.data_extractor_raspa3 import (
                find_and_process_files_by_csv_template as raspa3_by_csv,
            )
